...
;;
;; このコピーは kotoba-lang/ip 用に schema-path のみ調整（manifest/ が無いので
;; リポジトリルート直下 schema.edn）。他のロジックは
;; com-junkawasaki/root の manifest/edn-datomize.bb（現 .cljs）/
;; kotoba-lang/security の edn-datomize.bb と同一。
